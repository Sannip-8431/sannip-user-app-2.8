...
import 'package:sannip/features/brands/domain/repositories/brands_repository.dart';
import 'package:sannip/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:sannip/features/brands/domain/services/brands_service.dart';
...
import 'package:sannip/features/business/domain/repositories/business_repo.dart';
import 'package:sannip/features/business/domain/repositories/business_repo_interface.dart';
import 'package:sannip/features/business/domain/services/business_service.dart';
import 'package:sannip/features/business/domain/services/business_service_interface.dart';
import 'package:sannip/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:sannip/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:sannip/features/home/controllers/home_controller.dart';
import 'package:sannip/features/home/domain/repositories/home_repository.dart';
import 'package:sannip/features/home/domain/repositories/home_repository_interface.dart';
import 'package:sannip/features/home/domain/services/home_service.dart';
import 'package:sannip/features/home/domain/services/home_service_interface.dart';
...
import 'package:sannip/features/banner/domain/repositories/banner_repository.dart';
import 'package:sannip/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:sannip/features/banner/domain/services/banner_service.dart';
import 'package:sannip/features/banner/domain/services/banner_service_interface.dart';
import 'package:sannip/features/cart/domain/repositories/cart_repository.dart';
import 'package:sannip/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:sannip/features/cart/domain/services/cart_service.dart';
import 'package:sannip/features/cart/domain/services/cart_service_interface.dart';
import 'package:sannip/features/category/controllers/category_controller.dart';
import 'package:sannip/features/category/domain/reposotories/category_repository.dart';
import 'package:sannip/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:sannip/features/category/domain/services/category_service.dart';
import 'package:sannip/features/category/domain/services/category_service_interface.dart';
import 'package:sannip/features/chat/controllers/chat_controller.dart';
import 'package:sannip/features/chat/domain/repositories/chat_repository.dart';
import 'package:sannip/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:sannip/features/chat/domain/services/chat_service.dart';
import 'package:sannip/features/chat/domain/services/chat_service_interface.dart';
import 'package:sannip/features/coupon/controllers/coupon_controller.dart';
import 'package:sannip/features/coupon/domain/services/coupon_service.dart';
import 'package:sannip/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:sannip/features/favourite/controllers/favourite_controller.dart';
import 'package:sannip/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:sannip/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:sannip/features/favourite/domain/services/favourite_service.dart';
import 'package:sannip/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:sannip/features/flash_sale/controllers/flash_sale_controller.dart';
import 'package:sannip/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:sannip/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:sannip/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:sannip/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:sannip/features/html/controllers/html_controller.dart';
import 'package:sannip/features/html/domain/repositories/html_repository.dart';
import 'package:sannip/features/html/domain/repositories/html_repository_interface.dart';
import 'package:sannip/features/html/domain/services/html_service.dart';
...
import 'package:sannip/features/item/domain/repositories/campaign_repository.dart';
import 'package:sannip/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:sannip/features/item/domain/repositories/item_repository.dart';
import 'package:sannip/features/item/domain/repositories/item_repository_interface.dart';
import 'package:sannip/features/item/domain/services/campaign_service.dart';
import 'package:sannip/features/item/domain/services/campaign_service_interface.dart';
import 'package:sannip/features/item/domain/services/item_service.dart';
...
import 'package:sannip/features/language/domain/repository/language_repository.dart';
import 'package:sannip/features/language/domain/repository/language_repository_interface.dart';
import 'package:sannip/features/language/domain/service/language_service.dart';
import 'package:sannip/features/language/domain/service/language_service_interface.dart';
...
import 'package:sannip/features/taxi_booking/repo/cart_repo.dart';
import 'package:sannip/features/taxi_booking/repo/rider_repo.dart';
import 'package:sannip/api/api_client.dart';
import 'package:sannip/features/address/controllers/address_controller.dart';
import 'package:sannip/features/address/domain/repositories/address_repository.dart';
import 'package:sannip/features/address/domain/repositories/address_repository_interface.dart';
import 'package:sannip/features/address/domain/services/address_service.dart';
...
import 'package:sannip/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:sannip/features/auth/controllers/store_registration_controller.dart';
import 'package:sannip/features/auth/domain/reposotories/auth_repository.dart';
import 'package:sannip/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:sannip/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:sannip/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:sannip/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:sannip/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:sannip/features/auth/domain/services/auth_service.dart';
import 'package:sannip/features/auth/domain/services/auth_service_interface.dart';
import 'package:sannip/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:sannip/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:sannip/features/auth/domain/services/store_registration_service.dart';
...
import 'package:sannip/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:sannip/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:sannip/features/checkout/domain/services/checkout_service.dart';
import 'package:sannip/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:sannip/features/location/domain/repositories/location_repository.dart';
import 'package:sannip/features/location/domain/repositories/location_repository_interface.dart';
import 'package:sannip/features/location/domain/services/location_service.dart';
import 'package:sannip/features/location/domain/services/location_service_interface.dart';
import 'package:sannip/features/loyalty/controllers/loyalty_controller.dart';
import 'package:sannip/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:sannip/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:sannip/features/loyalty/domain/services/loyalty_service.dart';
...
import 'package:sannip/features/notification/domain/repository/notification_repository.dart';
import 'package:sannip/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:sannip/features/notification/domain/service/notification_service.dart';
import 'package:sannip/features/notification/domain/service/notification_service_interface.dart';
import 'package:sannip/features/onboard/controllers/onboard_controller.dart';
import 'package:sannip/features/onboard/domain/repository/onboard_repository.dart';
import 'package:sannip/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:sannip/features/onboard/domain/service/onboard_service.dart';
...
import 'package:sannip/features/order/domain/repositories/order_repository.dart';
import 'package:sannip/features/order/domain/repositories/order_repository_interface.dart';
import 'package:sannip/features/order/domain/services/order_service.dart';
...
import 'package:sannip/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:sannip/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:sannip/features/parcel/domain/services/parcel_service.dart';
import 'package:sannip/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:sannip/features/payment/controllers/payment_controller.dart';
import 'package:sannip/features/payment/domain/repositories/payement_repository.dart';
import 'package:sannip/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:sannip/features/payment/domain/services/payment_service.dart';
...
import 'package:sannip/features/profile/domain/repositories/profile_repository.dart';
import 'package:sannip/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:sannip/features/profile/domain/services/profile_service.dart';
import 'package:sannip/features/profile/domain/services/profile_service_interface.dart';
import 'package:sannip/features/review/controllers/review_controller.dart';
import 'package:sannip/features/review/domain/repositories/review_repository.dart';
import 'package:sannip/features/review/domain/repositories/review_repository_interface.dart';
import 'package:sannip/features/review/domain/services/review_service.dart';
import 'package:sannip/features/review/domain/services/review_service_interface.dart';
import 'package:sannip/features/search/controllers/search_controller.dart';
import 'package:sannip/features/search/domain/repositories/search_repository.dart';
import 'package:sannip/features/search/domain/repositories/search_repository_interface.dart';
import 'package:sannip/features/search/domain/services/search_service.dart';
import 'package:sannip/features/search/domain/services/search_service_interface.dart';
import 'package:sannip/features/splash/controllers/splash_controller.dart';
import 'package:sannip/features/splash/domain/repositories/splash_repository.dart';
import 'package:sannip/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:sannip/features/splash/domain/services/splash_service.dart';
import 'package:sannip/features/splash/domain/services/splash_service_interface.dart';
import 'package:sannip/features/store/controllers/store_controller.dart';
import 'package:sannip/features/store/domain/repositories/store_repository.dart';
import 'package:sannip/features/store/domain/repositories/store_repository_interface.dart';
import 'package:sannip/features/store/domain/services/store_service.dart';
import 'package:sannip/features/store/domain/services/store_service_interface.dart';
import 'package:sannip/features/verification/controllers/verification_controller.dart';
import 'package:sannip/features/verification/domein/reposotories/verification_repository.dart';
import 'package:sannip/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:sannip/features/verification/domein/services/verification_service.dart';
...
import 'package:sannip/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:sannip/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:sannip/features/wallet/domain/services/wallet_service.dart';
import 'package:sannip/features/wallet/domain/services/wallet_service_interface.dart';
