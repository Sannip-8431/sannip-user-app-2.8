...
import 'package:sannip/features/business/widgets/package_card_widget.dart';
import 'package:sannip/features/business/widgets/web_business_plan_widget.dart';
import 'package:sannip/features/dashboard/screens/dashboard_screen.dart';
import 'package:sannip/helper/responsive_helper.dart';
import 'package:sannip/features/splash/controllers/splash_controller.dart';
import 'package:sannip/features/business/widgets/base_card_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BusinessController>(builder: (businessController) {
      return PopScope(
        ...
        child: Scaffold(
          appBar: isDesktop
              ? CustomAppBar(title: 'business_plan'.tr, backButton: false)
              : null,
          ...
          body: Column(children: [
              ...
              child: SingleChildScrollView(
                child: FooterView(
                  ...
                  child: SizedBox(
                    width: Dimensions.webMaxWidth,
                    child: isDesktop
                        ? WebBusinessPlanWidget(storeId: widget.storeId)
                        : Column(children: [
                            Padding(
                                ...
                                Get.find<SplashController>()
                                    ...
                                    ? Expanded(
                                        child: BaseCardWidget(
                                          ...
                                          index: 0,
                                          onTap: () =>
                                              businessController.setBusiness(0),
                                        ),
                                      )
                                    : const SizedBox(),
                                SizedBox(
                                ...
                                Get.find<SplashController>()
                                    ...
                                    ? Expanded(
                                        child: BaseCardWidget(
                                          ...
                                          index: 1,
                                          onTap: () =>
                                              businessController.setBusiness(1),
                                        ),
                                      )
                                    : const SizedBox(),
                              ]),
                            ...
                            businessController.businessIndex == 0
                                ...
                                : Column(children: [
                                    ...
                                    businessController.packageModel != null
                                        ? SizedBox(
                                            height: 420,
            ...
            !isDesktop
                ? Container(
                    ...
                    child: CustomButton(
                      buttonText: businessController.businessIndex == 0
                          ? 'complete'.tr
                          : 'next'.tr,
                      onPressed: (businessController.businessIndex == 1 &&
                              businessController.packageModel == null &&
                              businessController
                          ...
                          : () {
                              if (businessController.businessIndex == 0) {
                                businessController.submitBusinessPlan(
                                    storeId: widget.storeId!, packageId: null);
                              } else {
                                Get.toNamed(
                                    RouteHelper.getSubscriptionPaymentRoute(
                                  storeId: widget.storeId,
                                  packageId: businessController
                                      .packageModel!
                                      .packages![businessController
                                          .activeSubscriptionIndex]
                                      .id,
                                ));
                              }
