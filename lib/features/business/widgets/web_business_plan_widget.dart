        ...
        Row(mainAxisAlignment: MainAxisAlignment.end, children: [
          ...
          CustomButton(
            ...
            onPressed: (businessController.businessIndex == 1 &&
                    businessController.packageModel == null &&
                    businessController.packageModel!.packages!.isEmpty)
                ? null
                : () {
                    if (businessController.businessIndex == 0) {
                      Get.toNamed(RouteHelper.getSubscriptionSuccessRoute(
                          fromSubscription: false, status: 'success'));
                    } else {
