...
import 'package:sannip/features/store/widgets/store_details_screen_shimmer_widget.dart';
          ...
          body: GetBuilder<StoreController>(builder: (storeController) {
            return GetBuilder<CategoryController>(
              ...
              if (storeController.store != null &&
                ...
                distance = Get.find<StoreController>().getRestaurantDistance(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                            "${'minimum_order'.tr} ${PriceConverter.convertPrice(store.minimumOrder)} ${(store.delivery! && store.freeDelivery!) ? '| ' : ''}",
                                            style: robotoMedium.copyWith(
                                              fontSize:
                                                  Dimensions.fontSizeSmall,
                                              color: Theme.of(context)
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: Row(children: [
                                              ...
                                              Expanded(
                                                child: Text(
                                                    '${distance > 100 ? '100+' : distance.toStringAsFixed(2)} ${'km'.tr} ${'away'.tr}',
                                                    style:
                                                        robotoMedium.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeSmall,
