...
import 'package:sannip/helper/notification_helper.dart';
import 'package:sannip/helper/responsive_helper.dart';
import 'package:sannip/helper/route_helper.dart';
import 'package:sannip/theme/dark_theme.dart';
import 'package:sannip/theme/light_theme.dart';
import 'package:sannip/util/app_constants.dart';
import 'package:sannip/util/messages.dart';
...
import 'package:sannip/features/home/widgets/cookies_view.dart';
...
Future<void> main() async {
  ...
  if (GetPlatform.isWeb) {
    ...
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyB0QRnOjXpMqqJ8MFkU2rrxzolW-XM15LE",
        appId: "1:793916535494:android:8bb18acb6a9facec381dc7",
        messagingSenderId: "793916535494",
        projectId: "user-sannip",
      ),
    );
  } else {
    await Firebase.initializeApp();
